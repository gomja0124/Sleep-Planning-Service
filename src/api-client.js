...
export const api = {
  ...
  communityPosts: () => request("/api/v1/community/posts/"),
  communityPost: (id) => request(`/api/v1/community/posts/${id}/`),
  createCommunityPost: (data) => request("/api/v1/community/posts/", { method: "POST", body: JSON.stringify(data) }),
  updateCommunityPost: (id, data) => request(`/api/v1/community/posts/${id}/`, { method: "PATCH", body: JSON.stringify(data) }),
  deleteCommunityPost: (id) => request(`/api/v1/community/posts/${id}/`, { method: "DELETE" }),
  likeCommunityPost: (id) => request(`/api/v1/community/posts/${id}/like/`, { method: "POST", body: "{}" }),
  addCommunityComment: (id, body) => request(`/api/v1/community/posts/${id}/comments/`, { method: "POST", body: JSON.stringify({ body }) }),
  deleteCommunityComment: (id) => request(`/api/v1/community/comments/${id}/`, { method: "DELETE" }),
